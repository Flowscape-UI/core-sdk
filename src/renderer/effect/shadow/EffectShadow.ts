...
import { ShadowMode, type IEffectShadow } from "./types";
import { EffectBase } from "../base";
import { EffectType } from "../../../nodes/shape/effect";

export class EffectShadow extends EffectBase implements IEffectShadow {
    ...
    public setMode(value: ShadowMode): void {
        if (this._mode === value) {
            return;
        }
        this._mode = value;
