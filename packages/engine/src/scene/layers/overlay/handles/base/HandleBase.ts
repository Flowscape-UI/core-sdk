...
export class HandleBase extends Enableable implements IHandleBase {
	...
	public setStrokeFill(value: string): void {
		...
		if (
			this._strokeFill &&
			formatRgb(this._strokeFill) === formatRgb(color)
		) {
			return;
		}
	...
	public setDebugFill(value: string | Color): void {
		...
		if (
			this._debugFill &&
			formatRgb(this._debugFill) === formatRgb(color)
		) {
			return;
		}
	...
	public setDebugStrokeFill(value: string | Color): void {
		...
		if (
			this._debugStrokeFill &&
			formatRgb(this._debugStrokeFill) === formatRgb(color)
		) {
			return;
		}
