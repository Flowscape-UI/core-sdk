...
export class HandleTransformResizeEdge
	extends HandleBase
	implements IHandleTransformResizeEdge
{
...
export class HandleTransformResizeVertex
	extends HandleBase
	implements IHandleTransformResizeVertex
{
	public readonly direction: Direction;
