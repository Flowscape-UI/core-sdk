...
export class RendererCanvasRect extends RendererCanvasBase<NodeRect> {
    ...
    private _getGradientPaint(
        ...
        const paint = transformTo<KonvaGradientPaint>(
            "konvajs",
            fillValue,
        );
        ...
        return new Konva.Shape({
            ...
            sceneFunc: (ctx, shape) => {
                ...
                const strokeFillMode =
                    (
                        shape.getAttr("strokeFillMode") as
                        | FillMode
                        | undefined
                    ) ?? FillMode.Color;
                ...
                switch (align) {
                    case StrokeAlign.Inside:
                        ...
                        innerRadius = {
                            tl: this._shrinkRadius(
                                baseRadius.tl,
                                tlDelta,
                            ),
                            tr: this._shrinkRadius(
                                baseRadius.tr,
                                trDelta,
                            ),
                            br: this._shrinkRadius(
                                baseRadius.br,
                                brDelta,
                            ),
                            bl: this._shrinkRadius(
                                baseRadius.bl,
                                blDelta,
                            ),
                        };
                    ...
                    case StrokeAlign.Center:
                        ...
                        outerRadius = {
                            tl: this._expandRadius(
                                baseRadius.tl,
                                tlDelta / 2,
                            ),
                            tr: this._expandRadius(
                                baseRadius.tr,
                                trDelta / 2,
                            ),
                            br: this._expandRadius(
                                baseRadius.br,
                                brDelta / 2,
                            ),
                            bl: this._expandRadius(
                                baseRadius.bl,
                                blDelta / 2,
                            ),
                        };
