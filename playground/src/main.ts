...
//   // autoResize: false
// });
// scene.getWorld().camera.setRotationRadians(0);
...
//   ellipseNode.setRotation(stepA);
//   polygonNode.setRotation(stepA);
//   starNode.setRotation(stepA);
//   lineNode.setRotation(stepA);
//   textNode.setRotation(stepA);
//   imageNode.setRotation(stepA);
//   videoNode.setRotation(stepA);
