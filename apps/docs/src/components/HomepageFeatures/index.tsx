...
function FeatureCard({ eyebrow, title, description, points, index }: FeatureCardProps) {
  return (
    ...
    <section className={styles.features}>
      <div className={styles.container}>
        <div className={styles.header}>
          <UiBadge as="div" className={styles.sectionBadge}>Why Flowscape</UiBadge>
          <h2 className={styles.title}>
            A 2D engine shaped for{' '}
            <span className={styles.titleAccent}>modern editor products</span>
          </h2>
          <p className={styles.subtitle}>
            Flowscape is not positioned as a generic canvas helper. It is being
            built as a foundation for tools that need scene structure, rendering
            flexibility and a product-level infinite canvas experience.
          </p>
        </div>
