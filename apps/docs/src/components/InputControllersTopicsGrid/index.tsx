...
const controllerTopics: ControllerTopicItem[] = [
  {
    ...
    name: 'Layer World IC',
    description: 'Built-in world input controller for camera pan/zoom and world-space interaction.',
  },
  {
    to: '/advanced/input-system/controllers/layer-overlay-ic',
    name: 'Layer Overlay IC',
    description: 'Built-in overlay input controller for handles, ownership, and overlay tool interaction.',
  },
  {
    to: '/advanced/input-system/controllers/custom-controller',
    name: 'Custom Controller',
    description: 'How to implement and register your own controller for product-specific interaction logic.',
  },
];
