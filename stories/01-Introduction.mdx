...
- **FrameNode (experimental)** — a new container node type inspired by Figma frames
  - Drag by label and by bbox with auto-pan support
  - Clipped content area via internal `contentGroup`

### ⚠️ Experimental Status & Limitations

- FrameNode is currently **experimental**, with intentional limitations:
...
- These scenarios are planned for future releases once the API and UX are fully stabilized.
